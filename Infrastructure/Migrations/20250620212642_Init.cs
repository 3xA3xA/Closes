        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueColor = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityMembers_GroupMembers_GroupMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizResults_GroupMembers_GroupMemberId",
                        column: x => x.GroupMemberId,
                        principalTable: "GroupMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizAnswers_GroupMembers_GroupMemberId",
                        column: x => x.GroupMemberId,
                        principalTable: "GroupMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizAnswers_QuizItems_QuizItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityMembers_GroupMemberId",
                table: "ActivityMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAnswers_GroupMemberId",
                table: "QuizAnswers",
                column: "GroupMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizAnswers_QuizItemId",
                table: "QuizAnswers",
                column: "QuizItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizResults_GroupMemberId",
                table: "QuizResults",
                column: "GroupMemberId");
