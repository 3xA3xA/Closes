...
import { QuizCheckPage } from './pages/private/QuizPage/QuizCheckPage/QuizCheckPage'
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route path="/quizSolution/:groupId/:groupMemberId/:quizId/passed" element={<QuizCheckPage />} />
